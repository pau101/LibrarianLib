...
class PastrySplitPaneView @JvmOverloads constructor(val vertical: Boolean = false) : GuiComponent(0, 0) {
    ...
    init {
        ...
        if(vertical) {
            val dividerThickness = PastryStyle.currentStyle.splitPaneDividerThickness
            ...
            layout {
                separator.layout.height eq dividerThickness
                separator.layout.left eq this.layout.left
                separator.layout.right eq this.layout.right
                separator.layout.topStay = Strength.PREFERRED
                ...
                middle.layout.sizeStay = Strength.REQUIRED
            ...
            layout {
                separator.layout.width eq dividerThickness
                separator.layout.top eq this.layout.top
                separator.layout.bottom eq this.layout.bottom
                separator.layout.leftStay = Strength.PREFERRED
