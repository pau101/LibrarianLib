 ...
 * * If the class has a static final field fixAnchorExpression `INSTANCE` with the same type as this class, gets the value of that field (if it is null, returns null)
