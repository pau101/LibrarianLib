...
object Symbolics {
    ...
    @Throws(NonlinearExpressionException::class)
    ...
    fun equals(first: Expression, second: Expression): Constraint {
        return Constraint(subtract(first, second), RelationalOperator.OP_EQ)
    }
    ...
    fun lessThanOrEqualTo(first: Expression, second: Expression): Constraint {
        return Constraint(subtract(first, second), RelationalOperator.OP_LE)
    }
    ...
    fun greaterThanOrEqualTo(first: Expression, second: Expression): Constraint {
        return Constraint(subtract(first, second), RelationalOperator.OP_GE)
    }
